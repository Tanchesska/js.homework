...
console.log("BruteForce: ", findOccurrencesBruteForce(S1, T1));  // Вывод: [3, 8]
console.log("Hashes: ", findOccurrencesWithHash(S1, T1));  // Вывод: [3, 8]

let S2 = "abababacaba";
let T2 = "aba";
console.log("Stroka 2:")
console.log("BruteForce: ", findOccurrencesBruteForce(S2, T2));  // Вывод: [1, 3, 5, 9]
console.log("Hashes: ", findOccurrencesWithHash(S2, T2));  // Вывод: [1, 3, 5, 9]
